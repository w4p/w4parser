...
public class Habrahabr {
    ...
    @W4Fetch(href = @W4Parse(xpath = "//a[class=\"post__title_link\"]/@href"), maxFetch = 2)
    ...
    public static class HabrahabrUser {
        ...
        @W4Parse(xpath = {"a[class=\"page-header__nickname\"]", "a[class=\"page-header__info-title\"]"})
    ...
    public static class HabrahabrArticle {
        ...
        @W4Parse(xpath = "//*[class=\"post__title\"]")
        private String title;

        @W4Fetch(href = @W4Parse(xpath = {"//a[class=\"author-info__nickname\"]/@href", "//a[class=\"page-header__info-title\"]/@href"}))
        private HabrahabrUser author;

//        @W4Parse(xpath = "//div[class*=\"post__body_full\"]", html = false)
//        private String text;
